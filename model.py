...
Uso esperado una vez tengáis la tabla de features real:
    ...
    modelo_ev, X_test, y_test = entrenar_modelo(X, y_ev, nombre="EV")
...
def entrenar_modelo(X: pd.DataFrame, y: pd.Series, nombre: str = "activo",
    ...
    Devuelve: (modelo_entrenado, X_test, y_test) — para poder evaluar después.
    """
    ...
    modelo = RandomForestClassifier(
        ...
        max_depth=None,          # dejamos que crezca; con bagging el riesgo de overfit es menor
...
if __name__ == "__main__":
    ...
    modelo, X_test, y_test = entrenar_modelo(X, y, nombre="EV (sintético)")
